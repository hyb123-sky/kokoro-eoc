      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="btn-icon text-kokoro-muted hover:text-kokoro-accent"
            title="データを更新"
          >
          ...
          <button
            ...
            className="btn-icon text-kokoro-muted hover:text-kokoro-accent relative"
            title="AI Copilot"
          >
          ...
          {/* Notifications */}
          <button
            className="btn-icon text-kokoro-muted hover:text-white relative"
            title="通知"
          >
